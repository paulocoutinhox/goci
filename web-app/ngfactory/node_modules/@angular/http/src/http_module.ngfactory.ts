...
class JsonpModuleInjector extends import0.NgModuleInjector<import1.JsonpModule> {
  ...
  get _BrowserJsonp_1():import9.BrowserJsonp {
    if ((this.__BrowserJsonp_1 == (null as any))) { (this.__BrowserJsonp_1 = new import9.BrowserJsonp()); }
  ...
  get _JSONPBackend_3():import10.JSONPBackend_ {
    if ((this.__JSONPBackend_3 == (null as any))) { (this.__JSONPBackend_3 = new import10.JSONPBackend_(this._BrowserJsonp_1,this._ResponseOptions_2)); }
